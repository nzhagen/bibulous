# -*- coding: utf-8 -*-
#
# Bibulous documentation build configuration file, created by
...
project = u'Bibulous'
copyright = u'2013, Bibulous developers'
...
latex_documents = [
  ('index', 'Bibulous.tex', u'Bibulous Documentation',
   u'Bibulous developers', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'banner.pdf'
